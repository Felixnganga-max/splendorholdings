...
const socials = [
  ...
  },
  {
    label: "LinkedIn",
    bg: "#0A66C2",
    href: "https://www.linkedin.com/in/splendor-holdings-0602a4265?utm_source=share_via&utm_content=profile&utm_medium=member_android",
    icon: (
  ...
  },
  {
    label: "Facebook",
    bg: "#1877F2",
    href: "https://www.facebook.com/share/18JUEMYS9Q/",
    icon: (
      <svg viewBox="0 0 24 24" fill="white" width="17" height="17">
  ...
  },
  {
    label: "TikTok",
    bg: "#010101",
    href: "https://www.tiktok.com/@splendor.holdings?_r=1&_t=ZS-95pR6WsCIuv",
    icon: (
      <svg viewBox="0 0 24 24" fill="white" width="17" height="17">
  ...
  // },
  {
    label: "YouTube",
    bg: "#FF0000",
    href: "https://youtube.com/@splendorholdings?si=-7_Z0OMVXYCZ9iMK",
    icon: (
      <svg viewBox="0 0 24 24" fill="white" width="17" height="17">
